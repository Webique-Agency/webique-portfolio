    ...
    const websiteDevPlans = [
        {
            ...
            mostPopular: false,
            icon: "/service-assets/website-development/basic-plan-icon-dark.png",
            included: [
                {
        ...
        },
        {
            ...
            mostPopular: true,
            icon: "/service-assets/website-development/standard-plan-icon-dark.png",
            included: [
                {
                    name: "Professional one-page website",
                    included: true,
        ...
        },
        {
            ...
            mostPopular: false,
            icon: "/service-assets/website-development/premium-plan-icon-dark.png",
            included: [
                {
                    name: "Professional one-page website",
                    included: true,
    ...
    return (
        <PageTransition>
            <section className="website-development-section service-section">
                ...
                <Image width={250} height={250} src={"/service-assets/website-development-v2.png"}
                        ...
                        <TabsList>
                            ...
                            {pricing == "monthly" && (
                                <Image className="discount-message" width={250} height={250}
                                       src={"/service-assets/website-development/discount-message-v2.png"}
                                       alt={"Save 20%"}/>
                            )}
                        </TabsList>
                        {/************************************* MONTHLY PRICING *************************************/}
                                        ...
                                        <div
                                            ...
                                            <div className="flex flex-col items-start justify-start gap-2 pt-8">
                                                {plan.included.map((serviceInList, index) => (
                                                    <div key={index}
                                                         className={"inline-flex gap-2 items-center justify-start"}>
                                                        {serviceInList.included ? <Check className="primary-accent"/> :
                                                            <Minus className="light-text"/>}
                                                        {serviceInList.name == 'Custom features' ?
                                                            <TooltipProvider>
                                                                <Tooltip>
                                                                    <TooltipTrigger>
                                                                        <p className={serviceInList.included ? '' : 'light-text'}>{serviceInList.name}</p>
                                                                    </TooltipTrigger>
                                                                    <TooltipContent>
